    ...
    <section id="" class="bg-white">
      <div class="py-3 px-4 mx-auto max-w-screen-xl lg:py-3 lg:px-6">
        <motion.div variants={textVariant(0.2)}
                    initial="hidden"
                    whileInView="show" class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
        ...
        <motion.div variants={fadeIn("right",0.2)}
                    initial="hidden"
                    whileInView="show" class="space-y-8 lg:grid lg:grid-cols-3 md:grid md:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div class="  flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900  rounded-3xl shadow-2xl  xl:p-8">
            <h3 class="mb-4 text-2xl font-mono">Company</h3>
            <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
